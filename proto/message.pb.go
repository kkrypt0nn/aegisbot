...
const file_proto_message_proto_rawDesc = "" +
	"\n" +
	"\x13proto/message.proto\x12\x05proto\x1a\x16proto/attachment.proto\x1a\x13proto/channel.proto\x1a\x12proto/member.proto\"\xc5\x01\n" +
	"\aMessage\x12\x18\n" +
	"\acontent\x18\x01 \x01(\tR\acontent\x12%\n" +
	"\x06author\x18\x02 \x01(\v2\r.proto.MemberR\x06author\x12(\n" +
	"\achannel\x18\x03 \x01(\v2\x0e.proto.ChannelR\achannel\x12\x1a\n" +
	"\bmentions\x18\x04 \x03(\tR\bmentions\x123\n" +
	"\vattachments\x18\x05 \x03(\v2\x11.proto.AttachmentR\vattachmentsB+Z)github.com/kkrypt0nn/aegisbot/proto;protob\x06proto3"
...
var file_proto_message_proto_goTypes = []any{
	...
	(*Attachment)(nil), // 3: proto.Attachment
}
var file_proto_message_proto_depIdxs = []int32{
	...
	3, // 2: proto.Message.attachments:type_name -> proto.Attachment
